Template.livecoin.onCreated(function () {
    ...
    Meteor.call('livecoin.loadMarkets', function (error, data) {
    ...
    this.loadSelectedMarketInfo = () => {
        Meteor.call('livecoin.fetchTrades', this.selectedMarket.get(), function (error, data) {
            handleFetchTrades(error, data);
        });
        Meteor.call('livecoin.fetchTicker', this.selectedMarket.get(), function (error, data) {
            handleFetchTicker(error, data);
        });
        Meteor.call('livecoin.fetchOrderBook', this.selectedMarket.get(), function (error, data) {
            handleOrderBook(error, data);
        });

        Meteor.call('livecoin.fetchBalance', function (error, data) {
           console.log(data);
           handleBalance(error, data);
        });
        //Meteor.call('livecoin.fetchMyTrades', this.selectedMarket.get(), function (error, data) {
        //    console.log(data);
